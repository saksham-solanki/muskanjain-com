...
/* Marquee items: 5 brands + 5 capability tags, mixed across two rows. */
const marqueeRowTop = [
  'Canton Foundation',
  'AEO',
  'KRNL Labs',
        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="col-span-12 lg:col-span-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              {/* connector beam from inputs into stages, lg+ only */}
            ...
            <ol className="space-y-2">
              {wf.stages.map((stage, i) => (
                <li key={stage.label}>
                  <div className="flex items-start gap-3 rounded-xl bg-white/65 ring-1 ring-ink/8 px-3 py-2.5">
          ...
          <div className="col-span-12 lg:col-span-3 flex flex-col gap-5">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                {/* second beam, stages -> outputs, slight delay */}
                <div className="hidden lg:block flex-1">
                  <PulseBeam delay={0.35 + index * 0.04} />
                </div>
              </div>
              <div className="flex flex-wrap gap-1.5">
                {wf.tiers.map((tier) => (
...
export default function ServicesPage() {
  return (
    <main className="min-h-screen pt-24">
      ...
      {/* ─── 2. Worked With strip, dual-direction marquee ─── */}
      <section className="bg-ink text-white relative overflow-hidden">
        <div className="container-width py-12 lg:py-14 px-6 sm:px-8">
          ...
          {/* Quick context line, preserved facts from workedWith data. */}
          <div className="mb-6 flex flex-wrap items-baseline gap-x-5 gap-y-1 text-[12px] text-white/55">
            {workedWith.map((w) => (
              <span key={w.name} className="tabular">
                <span className="font-bold text-white/85">{w.name}</span>
                <span className="text-white/35"> · {w.context}</span>
              </span>
            ))}
          </div>

          {/* Marquee, two rows scrolling opposite directions, edge-faded. */}
          <div
          ...
          >
            <div
              ...
              style={{
                animation: 'svc-marquee-l 40s linear infinite',
            ...
            >
              {[...marqueeRowTop, ...marqueeRowTop].map((item, i) => (
                <span
                  key={`top-${i}`}
                  className="inline-flex items-center gap-3 px-4 py-2 rounded-full ring-1 ring-white/10 bg-white/[0.03] font-mono text-[12px] tabular text-white/75 shrink-0"
                >
                  {item}
            ...
            <div
              className="flex gap-3 whitespace-nowrap will-change-transform"
              style={{
                animation: 'svc-marquee-r 50s linear infinite',
                animationPlayState: 'running',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.animationPlayState = 'paused'
            ...
            >
              {[...marqueeRowBottom, ...marqueeRowBottom].map((item, i) => (
                <span
                  key={`bot-${i}`}
                  className="inline-flex items-center gap-3 px-4 py-2 rounded-full ring-1 ring-white/10 bg-white/[0.03] font-mono text-[12px] tabular text-white/75 shrink-0"
                >
          ...
          {/* Inline keyframes, scoped to this page to avoid touching globals. */}
          <style jsx>{`
            @keyframes svc-marquee-l {
              from { transform: translateX(0); }
              to   { transform: translateX(-50%); }
            }
            @keyframes svc-marquee-r {
