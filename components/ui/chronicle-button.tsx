...
.chronicleButton span { position: relative; display: block; perspective: 108px; }
...
.chronicleButton:hover span:nth-of-type(1) em { opacity: 0; transform: rotateX(90deg) scaleX(.9) translate3d(0,-10px,0); }
